...
public class DateUtil {
	...
	private static String[] arrWeekdays = { "Sunday", "Monday", "Tuesday",
	...
	public static String getFormatDateTime(String strDateValue,
		...
		return getFormatDateTime(
				new SimpleDateFormat(strFormat1).parse(strDateValue),
				strFormat2);
	}
	...
	public static int getDateDiff(Date date1, Date date2) {
		...
		c2.setTime(date2);
		Long lngDiff = Long.valueOf((c1.getTime().getTime() - c2.getTime()
				.getTime()) / 86400000L);
	...
	public static void main(String[] args) {
		System.out.println(getDateOfFormat(System.currentTimeMillis(),
