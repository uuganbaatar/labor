...
@Entity
@Table(name = "company_helber")
@Inheritance(strategy = InheritanceType.JOINED)
@Audited(auditParents = BaseObject.class)
public class CompanyHelber extends BaseObject {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof CompanyHelber)) {
			return false;
		}

		final CompanyHelber u = (CompanyHelber) o;
