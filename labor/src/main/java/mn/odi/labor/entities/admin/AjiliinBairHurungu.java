...
@Entity
@Table(name = "ajliinbair_hurungu")
@Inheritance(strategy = InheritanceType.JOINED)
@Audited(auditParents = BaseObject.class)
public class AjiliinBairHurungu extends BaseObject {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof AjiliinBairHurungu)) {
			return false;
		}

		final AjiliinBairHurungu u = (AjiliinBairHurungu) o;
