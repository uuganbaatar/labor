...
@Entity
@Table(name = "economic_category")
@Inheritance(strategy = InheritanceType.JOINED)
@Audited(auditParents = BaseObject.class)
public class EconomicCategory extends BaseObject {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof EconomicCategory)) {
			return false;
		}

		final EconomicCategory u = (EconomicCategory) o;
